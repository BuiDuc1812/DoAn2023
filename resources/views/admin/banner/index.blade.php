        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Danh sách banner</li>
                </ol>
            </nav>
                        ...
                        <table id="example2" class="table table-bordered table-hover w-full">
                            ...
                            <tbody>
                               ...
                               <tr>
                                ...
                                <td><img src="{{url('uploads')}}/{{$item->image_banner}}" alt="" width="100px"></td>
                                <td>
                                    <a onclick="return confirm('Bạn thực sự muốn xóa banner này?')" class="btn btn-primary" href="{{ route('banner.destroy', $item->id) }}">Xoá</a>
                                </td>
                            </tr>
        ...
        <div class="container-fluid py-4">
            <div class="row min-vh-80">
                <div class="col-lg-8 col-md-10 col-12 m-auto">
                    <h3 class="mt-3 mb-0 text-center">THÊM MỚI BANNER</h3>
